...
const updateActivity = async (win) => {
  if (!win.isDestroyed()) {
    ...
    if (currentURL !== previousURL) {
      ...
      if (currentURL.includes('/scratch-gui/build/index.html') || currentURL.includes('gaiamod-main.github.io')) {
      ...
      } else if (currentURL.includes('/scratch-gui/build/addons.html') || currentURL.includes('gaiamod-main.github.io/addons.html')) {
